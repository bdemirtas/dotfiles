      ...
      spec = {
        {
          ...
          { "<leader>ap", desc = "Pull requests" },
          { "<leader>ai", desc = "Issues" },
          { "<leader>ac", desc = "Create PR" },
          { "<leader>aC", desc = "Create issue" },
          { "<leader>as", desc = "Search" },
          { "<leader>an", desc = "Review notes" },
          { "<leader>n", group = "notifications" },
          { "<leader>N", group = "obsidian" },
          { "<leader>Nt", desc = "Today" },
          { "<leader>Nn", desc = "New note" },
          { "<leader>Ns", desc = "Quick switch" },
          { "<leader>o", group = "opencode" },
          { "<leader>oa", desc = "Ask" },
          { "<leader>os", desc = "Select" },
          { "<leader>q", group = "session" },
          { "<leader>R", group = "kulala" },
          { "<leader>Rs", desc = "Send request" },
          { "<leader>Ra", desc = "Send all" },
